...
const QuestionCard = ({ 
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto"
    >
      {/* Question Header */}
      <div className="mb-6 sm:mb-8">
        ...
        <h2 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-800 leading-relaxed">
          {question.question}
        </h2>
      </div>
            ...
            return (
              <motion.button
                ...
                className={`
                  ...
                  flex items-start sm:items-center space-x-3 sm:space-x-4 group
                  ${isSelected
              ...
              >
                ...
                <div 
                  className={`
                    flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 flex items-center justify-center
                    font-semibold text-xs sm:text-sm transition-colors duration-200 mt-0.5 sm:mt-0
                    ${isSelected
                ...
                {/* Option Text */}
                <span className="flex-1 text-sm sm:text-base text-gray-700 group-hover:text-gray-800 leading-relaxed">
                  {option}
                </span>
